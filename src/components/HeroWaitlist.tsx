    ...
    <section className="flex flex-col items-center text-center pt-12 pb-20">
      ...
      >
        <div className="w-full overflow-x-auto pb-8 -mx-6 px-6 sm:mx-0 sm:px-0 scrollbar-hide">
          <div className="relative rounded-[2rem] bg-[#1C1C1E] border border-white/10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] shadow-indigo-500/5 flex flex-col h-[500px] min-w-[800px]">
            {/* Title Bar */}
            <div className="h-12 bg-white/[0.02] border-b border-white/5 flex items-center px-4 gap-2 relative shrink-0 rounded-t-[2rem]">
            ...
            <div className="flex flex-1 overflow-hidden rounded-b-[2rem]">
              {/* Sidebar */}
              <div className="w-64 bg-white/[0.02] border-r border-white/5 p-4 flex flex-col gap-4 shrink-0">
